...
export class ShareCard extends LitElement {
	...
	override render() {
      ...
      >
        ...
        <!-- Footer -->
        <div style="margin-top: 20px; font-size: 10px; color: rgba(255,255,255,0.18); text-align: center; letter-spacing: 0.25em; text-transform: uppercase;">speeedy-2vc.pages.dev · leia mais rápido, todo dia</div>
      </div>
    `;
	}
