...
Um adulto lê, em média, cerca de duzentas e trinta e oito palavras por minuto. Com a prática de RSVP, muitos leitores chegam confortavelmente a quatrocentas palavras por minuto mantendo uma boa compreensão. Você acabou de experimentar uma pequena amostra. Dê play no seu próprio texto e descubra qual é o seu número.`,
	...
	reader: {
		...
		pausedInstructions: "Pausado — clique em qualquer palavra para ir até ela e depois pressione reproduzir",
		...
		shortcutFocusMode: "Ativar/desativar modo foco (imersivo durante a reprodução)",
		keyTap: "Toque",
		shortcutTapPause: "Pausar — com o modo foco ativado, mostra os controles novamente",
	...
	settings: {
		theme: "Tema", light: "Claro", dark: "Escuro", speed: "Velocidade",
		fontSize: "Tamanho da fonte", letterSpacing: "Espaçamento entre letras",
		letterSpacingTip: "Ajuste o espaço horizontal entre os caracteres.",
		pivotOffset: "Deslocamento do pivô", centre: "Centro",
		pivotOffsetTip: "Move o ponto de foco para a esquerda ou direita se você preferir fixar o olhar fora do centro.",
		wordsPerFlash: "Palavras por exibição", oneWord: "1 palavra", words: "{count} palavras",
		wordsPerFlashTip: "Número de palavras exibidas a cada vez. Mais palavras = leitura mais rápida, mas pode reduzir a compreensão.",
		advancedTiming: "Temporização avançada", sentencePause: "Pausa na frase",
		sentencePauseTip: "Duração extra após pontos, pontos de interrogação e pontos de exclamação.",
		paragraphPause: "Pausa no parágrafo", paragraphPauseHint: "Tempo extra no início do parágrafo",
		paragraphPauseTip: "Atraso extra quando um novo parágrafo começa.", speedRamp: "Aceleração gradual",
		speedRampHint: "Acelere gradualmente até o alvo",
		speedRampTip: "Aumenta lentamente a velocidade no início da sessão para seu cérebro se ajustar.",
		targetWpm: "WPM alvo", accessibilityVisuals: "Acessibilidade e visuais",
		readingFont: "Fonte de leitura", dyslexicActive: "Modo dislexia ativo", fontWeight: "Peso da fonte",
		weightLight: "Leve", weightRegular: "Normal", weightMedium: "Médio",
		weightSemiBold: "Seminegrito", weightBold: "Negrito", weightExtraBold: "Extranegrito",
		fontWeightTip: "Um peso maior facilita acompanhar o texto. Muitos leitores disléxicos preferem pesos de médio a negrito.",
		visualHighlights: "Destaques visuais", pivotOrp: "Pivô (ORP)",
		orpHighlightColor: "Cor de destaque do pivô ORP", colorizeDialogue: "Colorir diálogos",
		colorizeDialogueTip: "Aplique uma cor diferente às palavras entre aspas duplas (diálogo).",
		quoteColor: "Cor das aspas", dialogueHighlightColor: "Cor de destaque das falas entre aspas",
		colorizeAsides: "Colorir apartes ( ) [ ]",
		colorizeAsidesTip: "Aplique uma cor diferente às palavras entre parênteses ou colchetes (apartes).",
		asideColor: "Cor dos apartes", asideHighlightColor: "Cor de destaque de parênteses e colchetes",
		dyslexiaFriendlyFont: "Fonte para dislexia",
		dyslexiaFriendlyFontTip: "Usa OpenDyslexic, uma fonte criada para melhorar a legibilidade para leitores neurodivergentes.",
		irlenOverlayTint: "Tonalidade da sobreposição Irlen", irlenPeach: "Pêssego", irlenMint: "Menta",
		irlenParchment: "Pergaminho", overlayIntensity: "Intensidade da sobreposição",
		overlayIntensityTip: "Ajuste a intensidade da tonalidade da cor.", pauseAnchor: "Pausa e âncora",
		pauseViewMode: "Modo de visualização na pausa", pauseFocus: "Foco", pauseContext: "Contexto",
		pauseFulltext: "Texto completo", bionicAnchorPosition: "Posição da âncora biônica",
		anchorEarly: "Início", anchorBalanced: "Equilibrada", anchorLate: "Final",
		readingFeatures: "Recursos de leitura", showProgressBar: "Mostrar barra de progresso",
		focusMode: "Modo foco (imersão)",
		focusModeTip: "Durante a reprodução, oculte o cabeçalho, a barra de progresso, os controles inferiores e as configurações para mostrar apenas as palavras. Toque na área de leitura ou pressione Espaço para pausar e exibir os controles novamente. Ative ou desative a qualquer momento com F.",
		orpGuideMarks: "Marcas-guia de ORP",
		orpGuideMarksTip: "Pequenas marcas acima e abaixo do ponto de foco ajudam você a fixar o olhar.",
		hideTrailingPunctuation: "Ocultar pontuação final", removeCitations: "Remover citações",
		removeCitationsTip: "Remova citações no texto, como [1], [1-3] e (Smith et al., 2020), para uma leitura acadêmica sem distrações.",
		tickerMode: "Modo contínuo",
		tickerModeTip: "Em vez de exibir uma palavra por vez, o texto rola horizontalmente no WPM configurado. Velocidade, pausa e navegação funcionam normalmente.",
		smartSpeedLogic: "Lógica de velocidade inteligente",
		smartSpeedTip: "Varia a duração de cada palavra conforme o número de caracteres (palavras maiores permanecem por mais tempo).",
		bionicReadingFixations: "Fixações de leitura biônica",
		bionicReadingTip: "Coloca as primeiras letras de cada palavra em negrito para guiar o olhar.",
		peripheralContext: "Contexto periférico",
		peripheralContextTip: "Mostra uma sombra das palavras anterior e seguinte para ajudar você a se orientar.",
		contextDensity: "Densidade (palavras de cada lado)", audioFocus: "Áudio e foco",
		tactileWordClicks: "Cliques táteis por palavra",
		tactileWordClicksTip: "Cliques procedurais suaves sincronizados com a exibição das palavras para dar foco rítmico.",
		clickPitchFactor: "Fator de tom do clique", ambientFocusNoise: "Ruído ambiente para foco",
		noiseWhite: "Branco", noisePink: "Rosa", noiseBrown: "Marrom", noiseVolume: "Volume do ruído",
		engineLogic: "Lógica do mecanismo", startCountdown: "Iniciar contagem regressiva (3 s)",
		startCountdownTip: "Mostre um cronômetro 3-2-1 antes de o texto começar a fluir.",
		commaPauseBeacon: "Sinal de pausa nas vírgulas",
		commaPauseTip: "Trate as vírgulas com a mesma pausa ponderada do fim de uma frase.",
		asideClosingPause: "Pausa ao fechar um aparte",
		asideClosingPauseTip: "Uma pequena pausa extra após fechar ) ou ] ajuda você a processar a expressão.",
		rewindSkipAmount: "Quantidade para retroceder", wordCountShort: "{count} p", wordSuffix: "p",
	},
	profile: {
		pageTitle: "Perfil",
		language: "Idioma",
	...
	wellness: {
		...
		sessions: "Sessões",
		eyeRestEnableHint: "Defina o foco como 20+ min para ativar o lembrete de descanso visual 20-20-20.",
		cancel: "Cancelar",
		start: "Iniciar",
		longBreakTitle: "Pausa longa!",
		breakTimeTitle: "Hora da pausa!",
		longBreakDescription: "Sessão {session} concluída. Reserve {minutes} minutos para recarregar completamente.",
		...
		eyeRestInstruction: "Olhe para algo a 6 metros de distância por 20 segundos.",
	},
	onboarding: {
