...
The average adult reads at around two hundred and thirty-eight words per minute. With practice on RSVP, many readers comfortably reach four hundred words per minute while maintaining strong comprehension. You just experienced a small sample. Hit play on your own text and see what your number is.`,
	...
	reader: {
		...
		pausedInstructions: "Paused — click any word to jump to it, then press play",
	...
	wellness: {
		...
		sessions: "Sessions",
		eyeRestEnableHint: "Set focus to 20+ min to enable the 20-20-20 eye rest reminder.",
		cancel: "Cancel",
		start: "Start",
		longBreakTitle: "Long Break!",
		breakTimeTitle: "Break Time!",
		longBreakDescription: "Session {session} done. Take {minutes} minutes to fully recharge.",
	...
	onboarding: {
		previewText: "Speeedy helps you read faster by focusing on the core of each word.",
		...
		accessibilityDescription: "Optional accessibility tools for focus and readability.",
		...
		settingsLater: "You can always change these settings later in the settings panel.",
		finish: "Finish",
	},
	errors: {
